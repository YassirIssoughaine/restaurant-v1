        ...
        <ul class="grid-list">
            ...
            <li class="feature-item">
                <div class="feature-card">
                    ...
                    <div class="card-icon">
                        <img src="{{ asset('images/features-icon-1.png') }}" width="100"
            ...
            <li class="feature-item">
                <div class="feature-card">
                    ...
                    <div class="card-icon">
                        <img src="{{ asset('images/features-icon-2.png') }}" width="100"
                            height="80" loading="lazy" alt="icon">
                    </div>
            ...
            <li class="feature-item">
                <div class="feature-card">
                    ...
                    <div class="card-icon">
                        <img src="{{ asset('images/features-icon-3.png') }}" width="100"
                            height="80" loading="lazy" alt="icon">
                    </div>
            ...
            <li class="feature-item">
                <div class="feature-card">
                    ...
                    <div class="card-icon">
                        <img src="{{ asset('images/features-icon-4.png') }}" width="100"
                            height="80" loading="lazy" alt="icon">
                    </div>
