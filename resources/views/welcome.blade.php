        ...
        <article>
                    ...
                    <ul class="grid-list">
                            ...
                            <div class="service-card">
                                ...
                                <a href="#" class="has-before hover:shine">
                                    <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                                        <img src="{{ asset('images/service-1.jpg') }}" width="285" height="336"
                        ...
                        <li>
                            <div class="service-card">
                                ...
                                <a href="#" class="has-before hover:shine">
                                    <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                                        <img src="{{ asset('images/service-2.jpg') }}" width="285" height="336"
                        ...
                        <li>
                            <div class="service-card">
                                ...
                                <a href="#" class="has-before hover:shine">
                                    <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                                        <img src="{{ asset('images/service-3.jpg') }}" width="285" height="336"
            ...
            <section class="section about text-center" aria-labelledby="about-label" id="about">
                <div class="container">
                    ...
                    <div class="about-content">
                        ...
                        <a href="tel:+804001234567" class="body-1 contact-number hover-underline">+80 (400) 123
                            4567</a>
                    ...
                    <figure class="about-banner">
                        ...
                        <img src="{{ asset('images/about-banner.jpg') }}" width="570" height="570" loading="lazy"
                            alt="about banner" class="w-100" data-parallax-item data-parallax-speed="1">

                        <div class="abs-img abs-img-1 has-before" data-parallax-item data-parallax-speed="1.75">
                            <img src="{{ asset('images/about-abs-image.jpg') }}" width="285" height="285"
                                loading="lazy" alt="" class="w-100">
                        </div>

                        <div class="abs-img abs-img-2 has-before">
                            <img src="{{ asset('images/badge-2.png') }}" width="133" height="134" loading="lazy"
                                alt="">
                        </div>

                    </figure>

                    <img src="{{ asset('images/shape-3.png') }}" width="197" height="194" loading="lazy"
                        alt="" class="shape">
            ...
            <section class="special-dish text-center" aria-labelledby="dish-label">
                ...
                <div class="special-dish-banner">
                    <img src="{{ asset('images/special-dish-banner.jpg') }}" width="940" height="900" loading="lazy"
                ...
                <div class="special-dish-content bg-black-10">
                    <div class="container">
                        ...
                        <img src="{{ asset('images/badge-1.png') }}" width="28" height="41" loading="lazy"
                ...
                <img src="{{ asset('images/shape-4.png') }}" width="179" height="359" loading="lazy" alt=""
                    class="shape shape-1">

                <img src="{{ asset('images/shape-9.png') }}" width="351" height="462" loading="lazy" alt=""
                    class="shape shape-2">
            ...
            <section class="section menu" aria-label="menu-label" id="menu">
                <div class="container">
                    ...
                    <ul class="grid-list">
                        ...
                        <li>
                            <div class="menu-card hover:card">
                                ...
                                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                                    <img src="{{ asset('images/menu-1.png') }}" width="100" height="100"
                                        loading="lazy" alt="Greek Salad" class="img-cover">
                                </figure>
                        ...
                        <li>
                            <div class="menu-card hover:card">
                                ...
                                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                                    <img src="{{ asset('images/menu-2.png') }}" width="100" height="100"
                                        loading="lazy" alt="Lasagne" class="img-cover">
                                </figure>
                        ...
                        <li>
                            <div class="menu-card hover:card">
                                ...
                                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                                    <img src="{{ asset('images/menu-3.png') }}" width="100" height="100"
                                        loading="lazy" alt="Butternut Pumpkin" class="img-cover">
                                </figure>
                        ...
                        <li>
                            <div class="menu-card hover:card">
                                ...
                                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                                    <img src="{{ asset('images/menu-4.png') }}" width="100" height="100"
                                        loading="lazy" alt="Tokusen Wagyu" class="img-cover">
                                </figure>
                        ...
                        <li>
                            <div class="menu-card hover:card">
                                ...
                                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                                    <img src="{{ asset('images/menu-5.png') }}" width="100" height="100"
                                        loading="lazy" alt="Olivas Rellenas" class="img-cover">
                                </figure>
                        ...
                        <li>
                            <div class="menu-card hover:card">
                                ...
                                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                                    <img src="{{ asset('images/menu-5.png') }}" width="100" height="100"
                                        loading="lazy" alt="Opu Fish" class="img-cover">
                                </figure>
                    ...
                    <img src="{{ asset('images/shape-5.png') }}" width="921" height="1036" loading="lazy"
                        alt="shape" class="shape shape-2 move-anim">
                    <img src="{{ asset('images/shape-6.png') }}" width="343" height="345" loading="lazy"
            ...
            <section class="section testi text-center has-bg-image"
                ...
                <div class="container">
                    ...
                    <div class="profile">
                        <img src="{{ asset('images/testi-avatar.jpg') }}" width="100" height="100" loading="lazy"
            ...
            <section class="section features text-center" aria-label="features">
                <div class="container">
                    ...
                    <img src="{{ asset('images/shape-7.png') }}" width="208" height="178" loading="lazy"
                    ...
                    <ul class="grid-list">
                        ...
                        <li>
                            <div class="event-card has-before hover:shine">
                                ...
                                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                                    <img src="{{ asset('images/event-1.jpg') }}" width="350" height="450"
                        ...
                        <li>
                            <div class="event-card has-before hover:shine">
                                ...
                                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                                    <img src="{{ asset('images/event-2.jpg') }}" width="350" height="450"
                                        loading="lazy" alt="Flavour so good you’ll try to eat with your eyes."
                                        class="img-cover">
                        ...
                        <li>
                            <div class="event-card has-before hover:shine">
                                ...
                                <div class="card-banner img-holder" style="--width: 350; --height: 450;">
                                    <img src="{{ asset('images/event-3.jpg') }}" width="350" height="450"
                                        loading="lazy" alt="Flavour so good you’ll try to eat with your eyes."
                                        class="img-cover">
    ...
    <footer class="footer section has-bg-image text-center"
        ...
        <div class="container">
            ...
            <div class="footer-bottom">
                ...
                <p class="copyright">
                    &copy; 2023 Grilli. All Rights Reserved | Crafted by <a href="https://sykweb.net/"
                        target="_blank" class="link">SYKWEB</a>
                </p>
